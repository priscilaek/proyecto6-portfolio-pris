                ...
                <div className="w-[100%] p-9 flex flex-col flex-nowrap gap-9">
                    ...
                    <div className="flex flex-row flex-wrap gap-7 items-center justify-center">
                        {projectData.details.url !== null && (
                            <a href={projectData.details.url} target="blank" rel="noreferrer" className="glassy-icon px-6 shrink-0">Visit Website</a>
                        )}
                        {projectData.details.githubUrl !== null && (
                            <a href={projectData.details.githubUrl} target="blank" rel="noreferrer" className="glassy-icon px-6 shrink-0">Visit GitHub Project</a>
                        )}
                    </div>
                </div>
            </dialog>
